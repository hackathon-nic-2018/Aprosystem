...
const Lineas = ({ data, navigation }) => (
    <SafeAreaView>
        <View style={style.container}>
            <ScrollView>
                <FlatList
                    data={data}
                    renderItem={({item}) => <LineaItem item={item} onPress={ (key) => navigation.navigate('lineasdata') } />}
...
export default withNavigation(Lineas);